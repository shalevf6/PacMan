...
$(document).ready(function() {
    ...
    settingsValidator = $('#settings_form').validate({
        ...
        submitHandler : function(form) {
            ball_amount = parseInt(document.getElementById('num_of_balls').value);
            enemy_amount = parseInt(document.getElementById('num_of_enemies').value);
            game_time = parseInt(document.getElementById('game_time').value);
